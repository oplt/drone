    ...
    queries: [
      {
        ...
        queryFn: () => fetchMissionDetail<any>(flightId!),
        enabled: Boolean(flightId),
      },
      {
        queryKey: ["mission-preflight", flightId],
        queryFn: () => fetchMissionPreflight<any>(flightId!),
        enabled: Boolean(flightId),
        retry: false,
      },
      {
        queryKey: ["mission-transitions", flightId],
        queryFn: () => fetchMissionTransitions<any>(flightId!),
        enabled: Boolean(flightId),
      },
      {
        queryKey: ["mission-commands", flightId],
        queryFn: () => fetchMissionCommands<any>(flightId!),
        enabled: Boolean(flightId),
      },
      {
        queryKey: ["mission-events", flightId],
        queryFn: () => fetchMissionEvents<any>(flightId!),
        enabled: Boolean(flightId),
      },
      {
        queryKey: ["mission-compliance", flightId],
        queryFn: () => fetchMissionCompliance<any>(flightId!),
        enabled: Boolean(flightId),
        retry: false,
      },
    ],
