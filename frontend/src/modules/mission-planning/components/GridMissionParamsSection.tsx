...
export type GridMissionParamsCopy = {
  title: string;
  missingFieldAlert: string;
  previewChipLabel: string;
  tooDenseAlert: (count: number, max: number) => string;
};

export const FIELD_SURVEY_GRID_COPY: GridMissionParamsCopy = {
  title: "Grid Survey Parameters",
  missingFieldAlert: "Draw or select a field polygon above to generate a grid preview.",
  previewChipLabel: "waypoints previewed",
  tooDenseAlert: (count, max) =>
    `Grid preview is too dense (${count}/${max} waypoints). Increase row spacing or row stride before starting the survey.`,
};

export const PHOTOGRAMMETRY_GRID_COPY: GridMissionParamsCopy = {
  title: "PhotoGrammetry Mission Parameters",
  missingFieldAlert:
    "Draw or select a field polygon above to generate a photogrammetry coverage preview.",
  previewChipLabel: "capture waypoints previewed",
  tooDenseAlert: (count, max) =>
          ...
          {fieldBorder && gridPreview && (
            ...
            >
              <Chip
                size="small"
                color="success"
                label={`${gridPreview.length} ${copy.previewChipLabel}`}
              />
