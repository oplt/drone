...
/* eslint-disable import/prefer-default-export, @typescript-eslint/no-explicit-any -- MUI picker theme map */
export const datePickersCustomizations: Record<string, any> = {
  MuiPickerPopper: {
    styleOverrides: {
