...
export WAREHOUSE_HEALTH_REFRESH_INTERVAL_S="${WAREHOUSE_HEALTH_REFRESH_INTERVAL_S:-10}"
export WAREHOUSE_HEALTH_DEEP_STALE_S="${WAREHOUSE_HEALTH_DEEP_STALE_S:-30}"
