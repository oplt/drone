...
from backend.db.models import AnomalyZone, CaptureRecord, InspectionPoint, ProcessedFieldLayer
...
async def get_irrigation_mission_summary(
    ...
    return IrrigationMissionSummaryOut(
        ...
        inspection_points=[InspectionPointOut.model_validate(item, from_attributes=True) for item in points],
        summary=summary,
    )
