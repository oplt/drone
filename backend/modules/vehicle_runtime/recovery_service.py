        ...
        **kwargs,
        ...
        if uses_warehouse_ros_preflight(mission_type):
            ...
            runtime_preflight = {
                ...
                "WEATHER_PREFLIGHT_ENABLED": settings.weather_preflight_enabled,
                "WEATHER_CACHE_TTL_S": settings.weather_cache_ttl_s,
                "WEATHER_API_FAIL_POLICY": settings.weather_api_fail_policy,
                "WIND_MAX": settings.WIND_MAX,
                "GUST_MAX": settings.GUST_MAX,
                "WEATHER_MAX_PRECIP_MM": settings.weather_max_precip_mm,
                "WEATHER_MIN_VISIBILITY_M": settings.weather_min_visibility_m,
                "WEATHER_MAX_CLOUD_COVER_PCT": settings.weather_max_cloud_cover_pct,
                "WEATHER_MIN_TEMP_C": settings.weather_min_temp_c,
                "WEATHER_MAX_TEMP_C": settings.weather_max_temp_c,
                "WEATHER_BLOCKED_CODES": settings.weather_blocked_codes,
                "WEATHER_WARN_CODES": settings.weather_warn_codes,
                "KMI_RMI_VALIDATION_ENABLED": settings.kmi_rmi_validation_enabled,
                "KMI_RMI_MAX_OBS_AGE_HOURS": settings.kmi_rmi_max_obs_age_hours,
                "KMI_RMI_WIND_DELTA_WARN_MPS": settings.kmi_rmi_wind_delta_warn_mps,
                "KMI_RMI_WIND_DELTA_BLOCK_MPS": settings.kmi_rmi_wind_delta_block_mps,
                "OPEN_METEO_BASE_URL": settings.open_meteo_base_url,
                "KMI_RMI_WFS_BASE_URL": settings.kmi_rmi_wfs_base_url,
            }
